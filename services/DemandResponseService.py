...
class DemandResponseService:
    ...
    def get_invitation(self, event_time):
        ...
        if len(invitations) != 0:
            ...
            return invitation['datetime'], invitation['event_time'], invitation['load_kwh'], invitation[
                'load_percentage'], invitation['response']
        return "", "", "", "", ""
    ...
    def add_benefit(self, iot, value):
        self.dr_repo.insert_benefit(iot, value)
        self.dr_repo.add_benefit(value)

    def get_benefit_historic(self):
        return self.dr_repo.get_benefit_historic()
